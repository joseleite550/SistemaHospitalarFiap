...
public class RabbitConfig {
	...
	@Bean
	Queue filaCancelarConsulta() {
		return new Queue(CANCELAR_CONSULTA, true);
	}
	...
	@Bean
	Binding bindingAtualizarConsulta(@Qualifier("filaAtualizarConsulta") Queue filaAtualizarConsulta,
			TopicExchange consultaExchange) {
